...
UID Mechanics::GetEntityInShotLine(Entity* shooter, Objects::Shot* shot)
{
...
bool Mechanics::IsColliding(Phys::Vector3 StartPosition, Phys::Vector3 ShootDirection, Phys::Vector3 TargetPosition, Phys::Vector3 TargetWidthHeightDepth) {
...
Shot* Objects::ShootAtDirection(Entity* Shooter, Phys::Vector3 aim)
{
	Shot* shot = new Shot();
